 ...
 *  @author Kevin Wayne
 */
public class DijkstraSP implements Testable {
    ...
    private void setup(EdgeWeightedDigraph G, int s) {
    ...
    @Override
    public void test() {
        File file = new File(getClass().getClassLoader().getResource("tinyEWD.txt").getFile());
        In in = new In(file);
