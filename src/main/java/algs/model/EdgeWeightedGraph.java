 ...
 *  main.java.algs.graph of vertices named 0 through <em>V</em> – 1, where each
 ...
 *  <em>V</em> in the main.java.algs.graph, and the number of edges <em>E</em> in the main.java.algs.graph.
 *  Parallel edges and self-loops are permitted.
 ...
 *  Constructing an empty edge-weighted main.java.algs.graph with <em>V</em> vertices takes
 *  &Theta;(<em>V</em>) time; constructing a edge-weighted main.java.algs.graph with
...
public class EdgeWeightedGraph {
    ...
    /**
     * Initializes an empty edge-weighted main.java.algs.graph with {@code V} vertices and 0 edges.
     *
    ...
    /**
     * Initializes a random edge-weighted main.java.algs.graph with {@code V} vertices and <em>E</em> edges.
     *
     * @param  V the number of vertices
    ...
    /**
     * Initializes a new edge-weighted main.java.algs.graph that is a deep copy of {@code G}.
     *
    ...
    /**
     * Adds the undirected edge {@code e} to this edge-weighted main.java.algs.graph.
     *
     * @param  e the edge
