 ...
 * literals, command-line arguments (via {@link Double#parseDouble(String)}) and standard output.
 * <p>
 * For additional documentation, see <a href="http://introcs.cs.princeton.edu/31datatype">Section 3.1</a> of <i>Introduction to
 * Programming in Java: An Interdisciplinary Approach</i> by Robert Sedgewick and Kevin Wayne.
 * <p>
 * Like {@link Scanner}, reading a token also consumes preceding Java whitespace, reading a full line consumes the following
 ...
 * 0x2028, 0x2029, 0x0085; see <tt><a href="http://www.docjar.com/html/api/java/util/Scanner.java.html">
...
public final class In
{
    ...
    /**
     * Is the input empty (except possibly for whitespace)? Use this to know whether the next call to {@link #readString()},
