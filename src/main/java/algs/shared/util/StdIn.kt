 ...
 * [StdIn.java](https://introcs.cs.princeton.edu/java/stdlib/StdIn.java)
...
object StdIn {
    ...
    fun readChar(): Char {
        return try {
            ...
            throw NoSuchElementException("attempts to read a 'char' value from standard input, "
    ...
    fun readString(): String {
        return try {
            ...
            throw NoSuchElementException("attempts to read a 'String' value from standard input, "
                    + "but no more tokens are available")
        }
    }
    ...
    fun readInt(): Int {
        return try {
            ...
            throw InputMismatchException("attempts to read an 'int' value from standard input, "
                    + "but the next token is \"" + token + "\"")
        } catch (e: NoSuchElementException) {
            throw NoSuchElementException("attemps to read an 'int' value from standard input, "
                    + "but no more tokens are available")
        }
    }
    ...
    fun readDouble(): Double {
        return try {
            ...
            val token = scanner!!.next()
            throw InputMismatchException("attempts to read a 'double' value from standard input, "
                    + "but the next token is \"" + token + "\"")
        } catch (e: NoSuchElementException) {
            throw NoSuchElementException("attempts to read a 'double' value from standard input, "
                    + "but no more tokens are available")
        }
    }
    ...
    fun readFloat(): Float {
        return try {
            ...
            val token = scanner!!.next()
            throw InputMismatchException("attempts to read a 'float' value from standard input, "
                    + "but the next token is \"" + token + "\"")
        } catch (e: NoSuchElementException) {
            throw NoSuchElementException("attempts to read a 'float' value from standard input, "
    ...
    fun readLong(): Long {
        return try {
            ...
            val token = scanner!!.next()
            throw InputMismatchException("attempts to read a 'long' value from standard input, "
                    + "but the next token is \"" + token + "\"")
        } catch (e: NoSuchElementException) {
            throw NoSuchElementException("attempts to read a 'long' value from standard input, "
                    + "but no more tokens are available")
        }
    }
    ...
    fun readShort(): Short {
        return try {
            ...
            val token = scanner!!.next()
            throw InputMismatchException("attempts to read a 'short' value from standard input, "
                    + "but the next token is \"" + token + "\"")
        } catch (e: NoSuchElementException) {
            throw NoSuchElementException("attempts to read a 'short' value from standard input, "
                    + "but no more tokens are available")
        }
    }
    ...
    fun readByte(): Byte {
        return try {
            ...
            val token = scanner!!.next()
            throw InputMismatchException("attempts to read a 'byte' value from standard input, "
                    + "but the next token is \"" + token + "\"")
        } catch (e: NoSuchElementException) {
            throw NoSuchElementException("attempts to read a 'byte' value from standard input, "
                    + "but no more tokens are available")
        }
    }
    ...
    fun readBoolean(): Boolean {
        try {
            ...
            throw InputMismatchException("attempts to read a 'boolean' value from standard input, "
                    + "but the next token is \"" + token + "\"")
        } catch (e: NoSuchElementException) {
            throw NoSuchElementException("attempts to read a 'boolean' value from standard input, "
                    + "but no more tokens are available")
        }
    }
    ...
    fun readAllLongs(): LongArray {
        val fields = readAllStrings()
        val vals = LongArray(fields.size)
        for (i in fields.indices) vals[i] = fields[i]!!.toLong()
        return vals
    }
     ...
     */
    private fun resync() {
        setScanner(Scanner(BufferedInputStream(System.`in`), CHARSET_NAME))
    }
